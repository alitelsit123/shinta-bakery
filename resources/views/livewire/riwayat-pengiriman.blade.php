<div>
  ...
  <div class="container">
    @forelse (\App\Models\Transaction::whereCourier_id(auth()->id())->whereIn('status', ['settlement'])->get() as $transaction)
    <!-- Row start -->
    <div class="card">
      <div class="card-body">
          ...
          <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
            <div class="invoice-details d-flex justify-content-between p-4">
              <address style="font-size: 18px;">
                ...
                Alamat: {{$transaction->delivery_address ?? ($transaction->user ? $transaction->user->address: '')}}
