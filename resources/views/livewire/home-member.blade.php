                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10">
                                <div class="sliderContainer fullWidth clearfix" style="position: relative; z-index: 0;">
                                    <div id="full-width-slider" class="royalSlider heroSlider rsMinW  rsHor rsWithBullets" style="padding: 0px; top: 0px; height: 412.688px;"><div class="rsOverflow grab-cursor" style="width: 915px; height: 413px;"><div class="rsContainer" style="transition-duration: 600ms; transform: translate3d(-2769px, 0px, 0px); transition-timing-function: cubic-bezier(0.445, 0.05, 0.55, 0.95);"><div style="left: 1846px;" class="rsSlide "><div class="rsContent">
                                                    ...
                                                    </div></div><div style="left: 2769px;" class="rsSlide "><div class="rsContent">
                                                        <div style="position: relative; text-align: center;">
                                                    ...
                                                    </div></div><div style="left: 3692px;" class="rsSlide "><div class="rsContent" style="visibility: visible; opacity: 1; transition: opacity 400ms ease-in-out 0s;">
                                                        <div style="position: relative; text-align: center;">
                                                    ...
                                                    </div></div></div></div><div class="rsNav rsBullets"><div class="rsNavItem rsBullet"><span></span></div><div class="rsNavItem rsBullet"><span></span></div><div class="rsNavItem rsBullet"><span></span></div><div class="rsNavItem rsBullet rsNavSelected"><span></span></div></div><div class="rsArrow rsArrowLeft" style="display: block;"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight" style="display: block;"><div class="rsArrowIcn"></div></div></div>
                                </div>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="margin: 55px 0 25px 0;">
                                <div style="background-image: url('{{url('/base')}}/images/mkiri.png'); background-size: cover;" class="displainlinetop plepet"></div><div style="background-image: url('{{url('/base')}}/images/mtengah.png');text-transform: uppercase; " class="displainlinetop productselec">
                                ...
                                </div><div style="background-image: url('{{url('/base')}}/images/mkanan.png'); " class="displainlinetop plepet"></div>
                            </div>
                        </div>
                    </div>
                </div>
                   ...
                   <div class="row">
                       <div class="col-md-12" style="margin:40px 0 30px 0;">
                        <div id="owl-demo" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                                        ...
                                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 6400px; left: 0px; display: block;"><div class="owl-item" style="width: 320px;"><div class="item" style="text-align:center;">
                                            <a href="product-list/roti/1.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/1.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>


                                            <div data-appear-animation="fadeInDown" style="font-family:kg_solid;font-size:32px ; color:#636267; line-height: 28px; padding: 30px 0 8px 0; text-transform: uppercase;" class="appear-animation">
                                                Roti
                                            </div>
                                            <div data-appear-animation="fadeInDown" style="font-family:kg_chasing; font-size:25px ; color:#636267; text-transform: uppercase; line-height: 28px;" class="appear-animation">
                                                Selection
                                            </div>
                                            <div data-appear-animation="fadeInDown" style="padding: 3px 0 0 0;" class="appear-animation">
                                                <img src="{{url('/base')}}/images/tiga.png" alt="">
                                            </div>
                                        </div></div><div class="owl-item" style="width: 320px;"><div class="item" style="text-align:center;">
                                            <a href="product-list/pudding/10.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/10.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/dessert/15.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/15.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/roti-tawar/12.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/12.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/donat/13.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/13.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/roti-jumbo/11.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/11.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/macaron/16.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/16.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/cakes/3.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/3.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/brownies/2.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/2.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                                            ...
                                            <a href="product-list/pastry/14.html">
                                               <div data-appear-animation="fadeInDown" style="background-image:url({{url('/base')}}/data/category/14.jpg);height:500px; background-repeat: no-repeat; background-position:center center;background-size:cover;" class="appear-animation"></div>
                                            </a>
                            ...
                            <div class="col-md-12" style="padding: 0;">
                                ...
                                <div class="col-md-4" style="border:0px solid red;">
                                    <div style="margin:0 0 0 0;">
                                        <div style="background-image: url('{{url('/base')}}/images/mkiric.png'); background-size: cover;" class="displainlinetop plepetcoklat"></div><div style="background-image: url('{{url('/base')}}/images/mtengahc.png');text-transform: uppercase; " class="displainlinetop productseleccoklat">
                                        ...
                                        </div><div style="background-image: url('{{url('/base')}}/images/mkananc.png'); " class="displainlinetop plepetcoklat"></div>
                                    </div>
                            ...
                            <div class="col-md-12" style="margin: 60px 0 0 0 ; text-align: center;">
                                    ...
                                    <center>
                                         ...
                                         <div class="col-md-3" style="padding-left:5px; padding-right: 5px;">
                                                    ...
                                                    <div style="width:100%; background-image:url({{url('/base')}}/data/product/239.jpg); height:333px; background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                                    </div>
                                                    <div data-appear-animation="fadeInDown" style="font-size:28px; line-height: 31px; color:#59585d;  font-family: coolvetica; padding: 20px 0 23px 0;" class="appear-animation">
                                                        Roti Keju Jomblo
                                                    </div>
                                                </div> <div class="col-md-3" style="padding-left:5px; padding-right: 5px;">
                                                    <div style="width:100%; background-image:url({{url('/base')}}/data/product/143.jpg); height:333px; background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                                    </div>
                                                    <div data-appear-animation="fadeInDown" style="font-size:28px; line-height: 31px; color:#59585d;  font-family: coolvetica; padding: 20px 0 23px 0;" class="appear-animation">
                                                        Red velvet
                                                    </div>
                                                </div> <div class="col-md-3" style="padding-left:5px; padding-right: 5px;">
                                                    <div style="width:100%; background-image:url({{url('/base')}}/data/product/126.jpg); height:333px; background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                                    </div>
                                                    <div data-appear-animation="fadeInDown" style="font-size:28px; line-height: 31px; color:#59585d;  font-family: coolvetica; padding: 20px 0 23px 0;" class="appear-animation">
                                                        Roti bantal coklat
                                                    </div>
